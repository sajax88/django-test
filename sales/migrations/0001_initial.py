    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["category"], name="sales_produ_categor_442310_idx"
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        django.db.models.functions.datetime.TruncDate("date_of_sale"),
                        models.F("date_of_sale"),
                        name="date_of_sale_date_idx",
                    )
                ],
            },
        ),
